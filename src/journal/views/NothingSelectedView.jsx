...
export const NothingSelectedView = () => {
    ...
    const notesState = useSelector(state => state.notes); // Assuming you have a notes slice in your Redux state
                ...
                sortedNotes.map(note => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Grid item sx={{ mt: 1 }}>
                                <Button onClick={() => handleSaveComment(id)}>Guardar Comentario</Button>
                            </Grid>
